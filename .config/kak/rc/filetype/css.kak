...
add-highlighter shared/css/declaration/base/ regex         [A-Za-z][A-Za-z0-9_-]* 0:keyword
add-highlighter shared/css/declaration/base/ regex [*]|[#.][A-Za-z][A-Za-z0-9_-]* 0:variable
...
add-highlighter shared/css/declaration/base/ regex ([A-Za-z][A-Za-z0-9_-]*)\h*: 1:operator
add-highlighter shared/css/declaration/base/ regex !important 0:+i
...
# pseudo
add-highlighter shared/css/selector/ regex (:{1,2})([a-z-]+) 2:attribute
# at-rules
add-highlighter shared/css/selector/ regex @[a-z-]+ 0:function 
# https://developer.mozilla.org/en-US/docs/Web/CSS/length
add-highlighter shared/css/selector/ regex (#[0-9A-Fa-f]+)|((\d*\.)?\d+(ch|cm|em|ex|mm|pc|pt|px|rem|vh|vmax|vmin|vw)) 0:value
add-highlighter shared/css/selector/ regex ([A-Za-z][A-Za-z0-9_-]*)\h*: 1:operator
