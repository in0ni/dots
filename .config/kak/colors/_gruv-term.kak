evaluate-commands %sh{
    ...
    red="rgb:%{{theme_dark_red}}"
    green="rgb:%{{theme_dark_green}}"
    yellow="rgb:%{{theme_dark_yellow}}"
    blue="rgb:%{{theme_dark_blue}}"
    purple="rgb:%{{theme_dark_purple}}"
    aqua="rgb:%{{theme_dark_aqua}}"
    orange="rgb:%{{theme_select}}"
